...
var Results = []Result{
	...
	},
	{
		...
		D:             2,
		Length:        283,
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(4,0,greedy)),continued_fractions(binary)))",
	...
	},
	{
		...
		D:             2,
		Length:        292,
		AlgorithmName: "opt(dictionary(hybrid(18,sliding_window(12,6,shorten)),continued_fractions(binary)))",
	...
	},
	{
		...
		D:             2,
		Length:        433,
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(5,0,shorten)),continued_fractions(dichotomic)))",
	...
	},
	{
		...
		D:             2,
		Length:        293,
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(4,0,greedy)),continued_fractions(dichotomic)))",
	...
	},
	{
		...
		D:             2,
		Length:        83 + 498,
		AlgorithmName: "opt(dictionary(hybrid(20,sliding_window(16,8,shorten)),continued_fractions(binary)))",
	...
	},
	{
		...
		D:             2,
		Length:        263,
		AlgorithmName: "opt(dictionary(hybrid(64,sliding_window(3,0,greedy)),continued_fractions(dichotomic)))",
	},
	{
		Name:          "E-382 Field Inversion",
		Slug:          "p382105_field",
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(5,0,greedy)),continued_fractions(dichotomic)))",
		N:             prime.P382105,
		D:             2,
		Length:        395,
	},
	...
	},
	{
		...
		D:             2,
		Length:        203,
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(2,0,greedy)),continued_fractions(dichotomic)))",
	},
	{
	...
	},
	{
		...
		D:             2,
		Length:        205,
		AlgorithmName: "opt(dictionary(hybrid(0,sliding_window(3,0,greedy)),continued_fractions(dichotomic)))",
	},
	{
